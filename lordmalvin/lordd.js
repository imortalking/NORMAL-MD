...
const sleep =  (ms) =>{
  ...
  lords({ nomCom: "tgs", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
lords({ nomCom: "crew", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
lords({ nomCom: "left", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
lords({ nomCom: "join", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
lords({ nomCom: "jid", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
lords({ nomCom: "block", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
lords({ nomCom: "unblock", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
lords({ nomCom: "kickall", categorie: 'Group', reaction: "📣" }, async (dest, zk, commandeOptions) => {
...
lords({ nomCom: "save", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
